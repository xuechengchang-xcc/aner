...
import com.xcc.realm.UserRealm;
import com.xcc.service.PermissionService;
import com.xcc.service.RoleService;
...
public class ShiroTest {
    ...
    public void test() {
        ...
        token = new UsernamePasswordToken(u1.getUsername(), password);
        subject.login(token);
